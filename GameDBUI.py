...
# Form implementation generated from reading ui file 'GameDB.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "RDB Browser", None))
        self.treeWidget.headerItem().setText(0, _translate("MainWindow", "Databases", None))
